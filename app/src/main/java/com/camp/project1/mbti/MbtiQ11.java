...
public class MbtiQ11 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_mbti_q11, container, false);
        answer1 = rootView.findViewById(R.id.Q11A1);
        answer2 = rootView.findViewById(R.id.Q11A2);
        backbutton = rootView.findViewById(R.id.button11);
    ...
    public void onClick(View view){
        ...
        activity.replaceFragment(activity.mbtiQ12);
    }
}
