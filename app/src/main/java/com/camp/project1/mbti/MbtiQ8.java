...
public class MbtiQ8 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_mbti_q8, container, false);
        answer1 = rootView.findViewById(R.id.Q8A1);
        answer2 = rootView.findViewById(R.id.Q8A2);
        backbutton = rootView.findViewById(R.id.button8);
