...
public class MbtiQ10 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_mbti_q10, container, false);
        answer1 = rootView.findViewById(R.id.Q10A1);
        answer2 = rootView.findViewById(R.id.Q10A2);
        backbutton = rootView.findViewById(R.id.button10);
    ...
    public void onClick(View view){
        switch (view.getId()){
            ...
            case R.id.button10:
                ...
                activity.replaceFragment(activity.mbtiQ9);
                return;
        }
